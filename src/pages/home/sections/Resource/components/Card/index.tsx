    ...
    >
      ...
      <div className={styles['card-body']} style={bodyStyle}>
        <div className={styles['card-body-resource-list']}>
          {bodyResourceList.map(({ name, href, logo }) => (
            ...
            >
              <div className={styles['card-body-resource-item-logo']}>
                {logo}
              </div>
              <div className={styles['card-body-resource-item-name']}>
                {name}
              </div>
            </a>
          ))}
      ...
      <div className={styles['card-footer']}>
        {footerResourceList.map(({ name, href, logo }) => (
          ...
          >
            {logo && (
              <div className={styles['card-footer-resource-item-logo']}>
                {logo}
              </div>
            )}
            <div className={styles['card-footer-resource-item-name']}>
              {name}
            </div>
